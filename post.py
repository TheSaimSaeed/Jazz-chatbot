...
URL = 'https://jazz.com.pk/postpaid/price-plans'
headers = {
...
for i, card in enumerate(cards):
    try:
        # Extract plan name
        h5 = card.find('h5', class_='color-black')
        h4 = card.find('h4', class_='color-golden')
...
# Save to JSON file
with open('jazz_offers_postpaid.json', 'w', encoding='utf-8') as f:
